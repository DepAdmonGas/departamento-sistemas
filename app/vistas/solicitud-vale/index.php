...
<head>
  ...
  <script type="text/javascript">
    $(document).ready(function($) {
      ...
      contenidoSolicitudVale();
    });

    function contenidoSolicitudVale(){

        $('#contenidoSolicitudVale').load('app/vistas/solicitud-vale/contenido-tabla-solicitud-vale.php', function() {
        $('#tabla-solicitud-vale').DataTable({
          "language": {
...
<body>
  ...
  <div id="content">
    ...
    <li aria-current="page" class="breadcrumb-item active text-uppercase">Solicitud Vale</li>
    </ol>
    </div>

    <h3 class="text-secondary">Solicitud Vale</h3>
    <div id="contenidoSolicitudVale" class="mt-3"></div>
