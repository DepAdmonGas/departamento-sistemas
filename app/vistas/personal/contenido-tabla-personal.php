      ...
      ?>
        <tr>
          ...
          <td class="no-hover p-0">
            <div class="form-control border-0 text-start p-0 ms-1" style="font-size: 1em; width:auto;" contenteditable="false"><?= $puesto ?></div>
          </td>
          <td class="no-hover p-0" ondblclick="habilitarEdicion(this)">
          ...
          <td class="no-hover p-0">
            <div class="form-control border-0 text-start p-0 ms-1" style="font-size: 1em; width:auto;" contenteditable="false"><?= $estacion ?></div>
          </td>
